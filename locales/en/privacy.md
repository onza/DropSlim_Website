...
Our host collects the following data that your browser transmits in log files: IP address, the address of the previously visited website (referrer request header), date and time of the request, time zone difference to Greenwich Mean Time, content of the request, HTTP status code, amount of data transferred, website from which the request originates and information about the browser and operating system.
...
Further information on objection and removal options vis-à-vis GitHub can be found at: [https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement <span class="visually-hidden">(opens in new tab)</span>](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement)
...
<p class="legal-source">Source: eRecht24. GitHub Pages: GitHub. Translated with AI.</p>
